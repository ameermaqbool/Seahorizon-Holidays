...
export default function BestTimeToVisitPage() {
  const whatsappUrl = `https://wa.me/918075301729?text=Hi Sea Horizon! I'd like to plan my Lakshadweep trip for the best weather. Can you help me choose the right dates?`;
