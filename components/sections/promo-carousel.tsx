...
export function PromoCarousel() {
  ...
  const whatsappUrl = `https://wa.me/918075301729?text=${encodeURIComponent(`Sea Horizon! I'm interested in the ${currentPromoData.title} offer. Can you share more details?`)}`;
